...
Call  : tID tPO { 
         ...
         // Réinitilisation du compte d'arguments et de l'offset
         arg_count=0;
         fun_offset=0;
      };
Args  : Arg tVIR Args
...
Ctrl  : tIF tPO Conds tPF {
         ...
         // Suppression de l'instruction NOP et définition de la ligne de saut
         jump_nop(at,get_last_line(at));
      }
      //TODO else
      | tWHILE tPO {
         // Début de la suite de conditions
         add_asm(at,CND,0,0,0);
      } Conds tPF {
         ...
         // Suppression de l'instruction NOP et définition de la ligne de saut de sortie
         jump_nop(at,get_last_line(at));
         // Suppression de l'instruction CND et définition de la ligne de retour aux conditions
         jump_cnd(at);
      };
